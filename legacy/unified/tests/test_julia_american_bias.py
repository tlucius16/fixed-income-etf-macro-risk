"""Opt-in smoke test for legacy/unified/julia/scripts/american_bias.jl.

Skipped unless Julia is installed AND RUN_JULIA_AMERICAN=1 is set; the default
suite remains fast and Julia-free.

    RUN_JULIA_AMERICAN=1 .venv/bin/python -m pytest legacy/unified/tests/test_julia_american_bias.py -v
"""
