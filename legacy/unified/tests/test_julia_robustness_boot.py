"""Opt-in test for legacy/unified/julia/scripts/robustness_boot.jl.
...
suite remains fast and Julia-free.
    ...
    RUN_JULIA_BOOTSTRAP=1 .venv/bin/python -m pytest legacy/unified/tests/test_julia_robustness_boot.py -v
"""
