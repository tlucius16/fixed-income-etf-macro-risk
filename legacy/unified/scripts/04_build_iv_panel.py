...
Usage
-----
    python legacy/unified/scripts/04_build_iv_panel.py
    python legacy/unified/scripts/04_build_iv_panel.py --start 2022-01-07 --end 2025-12-31
"""
...
from legacy.unified.src.data.options import (
...
_TICKER_SUMMARY = config.TICKER_SUMMARY_CSV
_OUT_PATH       = config.IV_PANEL_CSV
...
def main() -> None:
    ...
    if args.liquid_only:
        ...
        if not ts_path.exists():
            ...
            print("Run the screen first with legacy/unified/scripts/03_concat_screen.py.")
            sys.exit(1)
