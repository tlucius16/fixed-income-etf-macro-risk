...
Usage
-----
    python legacy/unified/scripts/08_paper_artifacts.py
"""
...
from legacy.unified.src.analysis.side_capacity import build_side_capacity
from legacy.unified.src.data.options_universe import BUCKET_ORDER, ETF_METADATA, UNIVERSE, ticker_bucket
