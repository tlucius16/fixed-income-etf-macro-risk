...
Usage
-----
    python legacy/unified/scripts/01_download_prices.py
    python legacy/unified/scripts/01_download_prices.py --start 2010-01-01 --out data/raw/prices.csv
"""
...
_DEFAULT_OUT   = config.RAW_PRICES_CSV
