...
capacity table consumed by legacy/unified/scripts/08_paper_artifacts.py.
...
Usage
-----
    python legacy/unified/scripts/07_robustness_ladder.py
"""
...
from legacy.unified.src.analysis.regression_utils import cgm_summary
from legacy.unified.src.analysis.side_capacity import build_side_capacity, merge_side
from legacy.unified.src.data.options_universe import ticker_bucket
