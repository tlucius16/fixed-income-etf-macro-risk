...
LEGACY_ROOT = PROJECT_ROOT / "legacy" / "unified"
...
PROCESSED_OFFLINE_DIR = PROJECT_ROOT / "data" / "processed" / "offline"
...
LEGACY_RAW_PRICES_CSV = PROJECT_ROOT / "data/exports/legacy_csv_exports/raw_prices.csv"
RAW_PRICES_CSV = PROJECT_ROOT / "data/raw/prices.csv"
...
OPTIONS_SCREEN_RAW_DIR = PROJECT_ROOT / "data/raw/options_screen"
OPTIONS_SCREEN_DIR     = PROJECT_ROOT / "data/processed/options_screen"
...
PAPER_DIR   = LEGACY_ROOT / "docs" / "hedge_capacity"
