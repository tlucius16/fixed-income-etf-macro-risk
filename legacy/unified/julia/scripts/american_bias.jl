...
#
# Usage:
#   julia --project=legacy/unified/julia legacy/unified/julia/scripts/american_bias.jl
#   julia --project=legacy/unified/julia legacy/unified/julia/scripts/american_bias.jl --steps 751 --max-rows 1000
...
const DEFAULT_OUT = joinpath(LEGACY, "docs", "hedge_capacity", "tables", "american_bias.csv")
